...
from .forms import AltaProductoForms, AltaProveedoresForms, PedidoClientesForms
...
def pedidos_cliente(request):
    ...
    contexto = {
        'pedidos_clientes_form': form
    }
    return render(request, 'inventario/pedido_clientes.html', contexto)
